...
class Operations{
	int menu()
	{
        ...
        System.out.println(" 5. Navigate back to the program");
        System.out.println(" 6. Close the current execution");
        System.out.println();
           ...
           {    
            ...
            case 4:System.out.println("Search a User Specified File");
				           ...
				           class FindFile 
							        ...
							        for (File fil : list)
							         {
						              if (fil.isDirectory())
							               ...
							               {
							                   System.out.println("File is found in current directory");
							               }
				            ...
				            obj.findFile(s1,new File(Filedir));
                            break;
            case 5: System.out.println("5.Navigate back to the program");
                    System.out.println("Return to Main Menu");
                    op.menu();
                     break;
            default :System.out.println("6. Close the current execution"); 
                        System.exit(0);
